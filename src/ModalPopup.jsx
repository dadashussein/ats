            ...
            <div className="w-full max-w-[380px] space-y-4">
                ...
                <div className="flex flex-col gap-6 items-center">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="text-[#101828] font-family-inter text-[30px] font-[600] text-center">
                            Welcome Back!
                        </div>
                        <div className="text-[#475467] text-[16px] font-family-inter text-center">
                            Join the thousands of happy 🎉 job seekers and successful companies on Himate.az!
                        </div>
                    </div>
                </div>
                {/* content */}
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-4">
                        <button
                            ...
                            className={`transition-all relative flex items-center gap-3 border-2 border-solid rounded-[10px] p-4 ${activeMenu === 1
                                ? 'border-green-500'
                        ...
                        >
                            ...
                            <div
                                className={`absolute right-4 w-4 h-4 rounded-full transition-all ${activeMenu === 1
                                    ? 'border-4 border-solid border-colors-foreground-fg-brand-primary-600'
                                    : 'border border-gray-300'
                                    }`}
                            ></div>
                        </button>
                        ...
                        >
                            ...
                            <div
                                className={`absolute right-4 w-4 h-4 rounded-full transition-all ${activeMenu === 2
                                    ? 'border-4 border-solid border-colors-foreground-fg-brand-primary-600'
                                    : 'border border-gray-300'
                                    }`}
                            ></div>
